                ...
                <div className="py-[6rem]">
                  <div className="w-full flex flex-col justify-center items-center gap-7 text-white px-[1.5rem]">
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-4 text-center">
                      <div className="w-fit border-t border-b py-2 text-[28px] font-semibold">हिमाचल प्रदेश विश्वविद्यालय</div>
                      <div>
                        <img className="w-[6rem] h-[6rem]" src="https://www.hpuniv.ac.in/images/hpu_logo.svg" alt="University College Of Business Studies"/>
                      </div>
                      <div className="w-fit border-t border-b py-2 text-[24px] font-medium">Himachal Pradesh University</div>
                    </div>
